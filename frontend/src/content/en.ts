...
export const en: LandingContent = {
  ...
  footer: {
    tagline:
      'Adversarial verification for autonomous AI. An independent critic cross-examines AI output; the producer defends or concedes; only contested disputes reach a human.',
    columns: [
      {
        head: 'Product',
        links: [
