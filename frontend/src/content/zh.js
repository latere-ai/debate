export const zh = {
    meta: {
        ...
        description: 'Agon —— 面向 AI 产出的对抗式验证关卡。由一位独立评审对 AI 产出进行交叉质询；生产方辩护或让步；只有仍存争议的部分才会交到人手中。',
    },
    nav: {
        by: 'by Latere',
        links: [
    ...
    found: {
        ...
        honestStrong: '诚实的表述：',
        honestRest: '形式可靠性结论是关于协议在既定假设下的性质，而非对任何特定模型的保证。应用于真实 LLM 是经验驱动、处于假设阶段的 —— 关卡指标是按维度的“评审发现缺陷率”。如果评审并不真正发起攻击，辩论就退化为只剩提议方。Agon 不证明你的代码正确，也不声称免除信任的必要。',
    },
    hook: {
