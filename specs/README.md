...
practical baseline: flat K-round debate, equal-protocol compute
...
|---|---|---|
| [08 Compute-asymmetric](https://github.com/changkun/agents-byzantine-tolerance/blob/main/specs/08-compute-asymmetric-debate.md) | Does soundness hold under {1×, 5×, 10×, 50×} compute asymmetry? | Per-role compute knobs (retries, per-role max-turn, per-role model). Minor change. |
...
The general pattern: the BFT-repo line asks "is debate sound under
